...
readFile('./package.json', 'utf8', async (err, data) => {
    if (err) {
        ...
        let isValid;
        do {
            let myOperation = await prompt("Please enter one action; for adding a new product press a,/n for finding a product press f,/n for saving and end press x:");
            ...
            console.log("Wrong!!! See you again!!");
        }
